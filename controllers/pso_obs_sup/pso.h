...
void fitness1(double [][DATASIZE1], double [], int neighbors[][SWARMSIZE]);                  // Fitness function for particle evolution
double rnd(void);                                                // Generate random number in [0,1]
void findPerformance(double[][DATASIZE],double[],double[],char,int,int[][SWARMSIZE],int);  // Find the current performance of the swarm
