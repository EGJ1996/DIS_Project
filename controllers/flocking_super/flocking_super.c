...
State 1: PSO optimize the braitenberg weights (for a certain number of iterations)
State 2: PSO optimize the reynolds rules weights
State 3: Reynolds + Braitenberg (Obstacle avoidance using braitenberg + flocking behavior)
*/
